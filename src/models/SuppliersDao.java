...
public class SuppliersDao {
    ...
    //Registrar proveedor
    public boolean registerSupploerQuery(Suppliers supplier) {
    ...
    //modificar proveedor
    public boolean updateSupploerQuery(Suppliers supplier) {
    ...
    public boolean deleteSupplierQuery(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No puedes eliminar un proveedor que tiene relacion con ptra tabla");
            return false;
        }
