...
public class ProductsDao {
    ...
    public boolean registerProductsQuery(Products product) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al registrar el rpoducto");
            return false;
        }
    ...
    //Modificar productos
     public boolean updateProductsQuery(Products product) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al modificar los datos del rpoducto");
            return false;
        }
     ...
     public Products searchCode(int code) {
         ...
         try {
             ...
             if(rs.next()) {
                 product.setId(rs.getInt("id"));
                 product.setName(rs.getString("name"));
                 product.setProduct_quantity(Integer.parseInt(rs.getString("product_quantity")));
                 product.setUnit_price(Double.parseDouble(rs.getString("unit_price")));
             }
