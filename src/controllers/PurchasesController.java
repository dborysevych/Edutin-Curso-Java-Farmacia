...
public class PurchasesController implements KeyListener, ActionListener, MouseListener {
                    ...
                    if (amount > 0) {
                        ...
                        for (int i = 0; i < views.purchases_table.getRowCount(); i++) {
                            if (views.purchases_table.getValueAt(i, 1).equals(views.txt_purchase_product_name.getText())) {
                                JOptionPane.showMessageDialog(null, "El producto ya esta registrado en la tabla de compres");
                                return;
                            }
                        }
    ...
    private void insertPurchase() {
        ...
        int emloyee_id = id_user;

        if (purchaseDao.registerPurchaseQuery(getIdSupplier, emloyee_id, total)) {
    ...
    public void listAllPurchases() {
        if (rol.equals("Administrador") || rol.equals("Auxilliar")) {
        ...
        if (e.getSource() == views.txt_purchase_product_code) {
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                if (views.txt_purchase_product_code.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Ingresa el codigo a comprar");
                } else {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.JLabelPurchases) {
            if (rol.equals("Administrador")) {
                ...
                JOptionPane.showMessageDialog(null, "No tiene privilegios de Admiistrador para ingresar a esta vista");
            }
