    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == views.btn_register_employee) {
            ...
            if(views.txt_employee_id.getText().equals("")) {
                ...
                if(employeeDao.updaterEmployeeQuery(employee)) {
                    cleanTable();
                    cleanFields();
                    listAllEmployees();
            ...
            if(row == -1) {
                ...
                int question = JOptionPane.showConfirmDialog(null, "En realidad quieres eliminae este emplaedo?");
            ...
            //Recolectar informacion de las cagas password
